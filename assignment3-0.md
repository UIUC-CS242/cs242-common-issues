...
#### Not pushing config files

All configuration files should be generated. Non-config autogenerated directories (i.e. `node_modules`) should not be.
...
package.json
package-lock.json or yarn-lock.json
